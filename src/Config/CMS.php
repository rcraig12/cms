...
return [
    ...
    */
    ...
    'widgets' => [
        [
            'name'  => 'User',
            'icon'  => 'voyager-group',
            'model' => RCS\CMS\Models\User::class,
            'url'   => 'admin/users',
        ...
        [
            'name'  => 'Post',
            'icon'  => 'voyager-news',
            'model' => RCS\CMS\Models\Post::class,
            'url'   => 'admin/posts',
        ...
        [
            ...
            'model' => RCS\CMS\Models\Page::class,
            'url'   => 'admin/pages',
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            'RCS\\CMS\\Widgets\\UserDimmer',
            'RCS\\CMS\\Widgets\\PostDimmer',
            'RCS\\CMS\\Widgets\\PageDimmer',
        ],
